...
<body>
            ...
            <section class="container-square">
                <?php if ($search) { ?>
                    ...
                    <div class="container-vagas">
                        <?php if (count($searchConteudo) > 0) { ?>
                            ...
                            <div class="vagas-conteudo-acoes">
                                <button class="vagas-acoes-btn-enviar"><a href="upload.php?id=' . $valueSearch['id'] . '">Enviar currículo</a></button>
                   ...
                   ';
                            ...
                            ?>
                        <?php } else {
                            echo '<p class="container-vaga-paragrafo">Não encontramos nenhuma vaga com as informações da sua pesquisa</p>';
                        } ?>
                    </div>

                <?php } ?>
                <h2 class="container-titulo">Sugestões de vaga</h2>
                <div class="container-sugestao">
                    ...
                    if ($randomVagasListar) {
                        ...
                        echo "<h2>Infelizmente ainda não temos nenhuma vaga cadastrada no nosso sistema</h2>";
                    }
                ...
                <h2 class="container-titulo">Últimas vagas adicionadas</h2>
                <div class="container-vagas">
                    <?php
                    ...
                    if ($ultimasVagasAdicionadas) {
                        foreach ($ultimasVagasAdicionadas as $vagaListar) {
                            ...
                            <div class="vagas-conteudo-acoes">
                                <div>
                                    <button class="vagas-acoes-btn-enviar"><a href="upload.php?id=' . $vagaListar['id'] . '">Enviar currículo</a></button>
    ...
    <?php if (isset($_SESSION['ERROR_REPORTING'])) { ?>
        <script>
            ...
            if (!$_SESSION['ERROR_REPORTING']) { ?>
                swal("Muito bom!", "As informações foram modificadas com sucesso!");
            <?php } else { ?>
                swal("Sinto muito!", "Não conseguimos modificar as informações!");
            <?php }
    ...
    <?php if (isset($_SESSION['CURRICULO_REPORTING'])) { ?>
        <script>
            ...
            <?php } else { ?>
                swal("Sinto muito!", "Não conseguimos enviar seu currículo!", "error");
            <?php }
