...
require_once('PAGES/VAGA/listar_vaga_editar.php');
...
$listarVaga = new VagaListarEditar();

$idVaga = isset($_GET['id']) ? $_GET['id'] : 0;
$idDono = $_SESSION['USER_ID'];
                    ...
                    <form action="PAGES/VAGA/atualizar_vaga.php" method="post">
                        ...
                        <div class="form-container">
                            <div class="container-vagaCrud-left">
                                <fieldset>
                                    <legend>País</legend>
                                    <input type="text" value="<?= $informacoes['pais'] ?>" placeholder="Digite o nome do seu País" name="pais" id="pais">
                                    <span class="material-icons-sharp">room</span>
                                </fieldset>
                                <fieldset>
                                    <legend>Estado</legend>
                                    <input type="text" value="<?= $informacoes['estado'] ?>" placeholder="Digite o nome do seu Estado" name="estado" id="estado">
                                    <span class="material-icons-sharp">room</span>
                                </fieldset>
                                <fieldset>
                                    <legend>Cidade</legend>
                                    <input type="text" value="<?= $informacoes['cidade'] ?>" placeholder="Digite o nome da sua Cidade" name="cidade" id="cidade">
                                    <span class="material-icons-sharp">room</span>
                                </fieldset>
                                <div class="fieldset-checkboxRadio">
                                    <legend>Tipo de contrato</legend>
                                    <div class="fieldset-checkboxRadio-div"><label for="freelance"><input type="checkbox" <?= $informacoes['tipo_contrato'] == "Freelance" ? 'checked' : '' ?> value="Freelance" name="tipoContrato" id="freelance"><span>Freelance</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="full-time"><input type="checkbox" <?= $informacoes['tipo_contrato'] == "Full-time" ? 'checked' : '' ?> value="Full-time" name="tipoContrato" id="full-time"><span>Full-time</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="internship"><input type="checkbox" <?= $informacoes['tipo_contrato'] == "Internship" ? 'checked' : '' ?> value="Internship" name="tipoContrato" id="internship"><span>Internship</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="part-time"><input type="checkbox" <?= $informacoes['tipo_contrato'] == "Part-time" ? 'checked' : '' ?> value="Part-time" name="tipoContrato" id="part-time"><span>Part-time</span></label></div>
                                </div>
                                <div class="fieldset-checkboxRadio">
                                    <legend>Level</legend>
                                    <div class="fieldset-checkboxRadio-div"><label for="junior"><input type="checkbox" <?= $informacoes['nivel'] == "junior" ? 'checked' : '' ?> name="nivel" value="junior" id="junior"><span>Junior</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="pleno"><input type="checkbox" <?= $informacoes['nivel'] == "pleno" ? 'checked' : '' ?> name="nivel" value="pleno" id="pleno"><span>Pleno</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="senior"><input type="checkbox" <?= $informacoes['nivel'] == "senior" ? 'checked' : '' ?> name="nivel" value="senior" id="senior"><span>Senior</span></label></div>
                                </div>
                                <div class="fieldset-checkboxRadio">
                                    <legend>Tipo</legend>
                                    <div class="fieldset-checkboxRadio-div"><label for="presencial"><input type="radio" <?= $informacoes['forma_trabalho'] == "Presencial" ? 'checked' : '' ?> name="formato" value="Presencial" id="presencial"><span>Presencial</span></label></div>
                                    <div class="fieldset-checkboxRadio-div"><label for="remoto"><input type="radio" <?= $informacoes['forma_trabalho'] == "Remoto" ? 'checked' : '' ?> name="formato" value="Remoto" id="remoto"><span>Remoto</span></label></div>
                                </div>
                            </div>
                            <div class="container-vagaCrud-right">
                                <fieldset>
                                    <legend>Titulo</legend>
                                    <input type="text" value="<?= $informacoes['titulo'] ?>" placeholder="Digite um Titulo para vaga" name="titulo" id="titulo">
                                </fieldset>
                                <fieldset>
                                    <legend>Nome da empresa</legend>
                                    <input type="text" value="<?= $informacoes['empresa'] ?>" placeholder="Digite o nome da sua empresa" name="empresa" id="empresa">
                                </fieldset>
                                <fieldset>
                                    <legend>Salário</legend>
                                    <input type="number" value="<?= $informacoes['salario'] ?>" placeholder="Digite qual valor você deseja pagar" name="salario" id="salario">
                                </fieldset>
                                <fieldset>
                                    <legend>Descrição da vaga</legend>
                                    <textarea placeholder="Adicione uma descrição da vaga" name="descricao" id="descricao"><?= $informacoes['descricao'] ?></textarea>
                                </fieldset>
                            </div>
                        </div>
        ...
        <div class="configuracao">
            ...
            <div class="configuracao-container">
                <form action="/PAGES/SETTINGS/modificar_informacoes.php" method="post" class="configuracao-form configuracao-setting configuracao-form-active">
                    ...
                    <input type="hidden" name="base_url" value="editar_vaga.php">
    ...
    <?php if (isset($_SESSION['VAGA_REPORTING'])) { ?>
        <script>
            ...
            if (!$_SESSION['VAGA_REPORTING']) { ?>
                swal("Muito bom!", "Vaga cadastrada com sucesso!", "success");
            <?php } else { ?>
                swal("Sinto muito!", "Não conseguimos cadastrar esta vaga. Por favor, tente novamente!", "error");
            <?php }
